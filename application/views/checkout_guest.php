...
<div class="row">
   <div class="col m10 s12 offset-m1">
      ...
      <div class="col m10 s12">
            ...
            <div class="row">
               <div class="input-field col m8 s12">
                  <input type="email" id="email" name="user_mail" value="" class="validate">
            ...
            <div class="row">
               <div class="input-field col m4 s12 offset-m8">
                  <input type="text" name="total" value="<?= intval($this->cart->total()); ?>" id="total" class="uang" readonly>
    ...
    var nama=$("#first_name").val();
    var ongkir=$('#ongkir').val();
    var nama_belakang=$("#last_name").val();
    var email=$("#email").val();
    var prov=$("#prov").val();
    var kab=$("#kota").val();
   ...
   // console.log(pos);
    $.ajax({
      ...
      data:{total:total,nama:nama,
            ongkir:ongkir,nama_belakang:nama_belakang,
            email:email,prov:prov,kab:kab,
